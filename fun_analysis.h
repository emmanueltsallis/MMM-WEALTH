...
/*****CLASS STATS*****/
EQUATION("YSH_1")
RESULT(VS(class1, "Class_Income_Share"))

EQUATION("YSH_2")
RESULT(VS(class2, "Class_Income_Share"))

EQUATION("YSH_3")
RESULT(VS(class3, "Class_Income_Share"))

EQUATION("YSH_4")
RESULT(VS(class4, "Class_Income_Share"))

EQUATION("YSH_5")
RESULT(VS(class5, "Class_Income_Share"))

EQUATION("YSH_6")
RESULT(VS(class6, "Class_Income_Share"))

EQUATION("WSH_1")
RESULT(VS(class1, "Class_Wealth_Share"))

EQUATION("WSH_2")
RESULT(VS(class2, "Class_Wealth_Share"))

EQUATION("WSH_3")
RESULT(VS(class3, "Class_Wealth_Share"))

EQUATION("WSH_4")
RESULT(VS(class4, "Class_Wealth_Share"))

EQUATION("WSH_5")
RESULT(VS(class5, "Class_Wealth_Share"))

EQUATION("WSH_6")
RESULT(VS(class6, "Class_Wealth_Share"))
