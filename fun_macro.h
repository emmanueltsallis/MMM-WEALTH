...
// Income shares, ordered poorest (class6) to richest (class1)
	v[1]=VS(class6, "Class_Income_Share");
	v[2]=VS(class5, "Class_Income_Share");
	v[3]=VS(class4, "Class_Income_Share");
	v[4]=VS(class3, "Class_Income_Share");
	v[5]=VS(class2, "Class_Income_Share");
	v[6]=VS(class1, "Class_Income_Share");

// Population shares, ordered poorest (class6) to richest (class1)
	v[7]=VS(class6, "class_population_share");
	v[8]=VS(class5, "class_population_share");
	v[9]=VS(class4, "class_population_share");
	v[10]=VS(class3, "class_population_share");
	v[11]=VS(class2, "class_population_share");
	v[12]=VS(class1, "class_population_share");

// Cumulative income shares (S_i), S_0 = 0
	v[13]=v[1];                                  // S_1 (cumulative income for class6)
	v[14]=v[13] + v[2];                          // S_2 (for class6 & class5)
	v[15]=v[14] + v[3];                          // S_3 (for class6 & class5 & class4)
	v[16]=v[15] + v[4];                          // S_4 (... & class3)
	v[17]=v[16] + v[5];                          // S_5 (... & class2)
	v[18]=v[17] + v[6];                          // S_6 (... & class1)

// Gini terms: P_i * (S_{i-1} + S_i)
	v[20]=v[7] * (0 + v[13]);      // Term for class6
	v[21]=v[8] * (v[13] + v[14]);  // Term for class5
	v[22]=v[9] * (v[14] + v[15]);  // Term for class4
	v[23]=v[10] * (v[15] + v[16]); // Term for class3
	v[24]=v[11] * (v[16] + v[17]); // Term for class2
	v[25]=v[12] * (v[17] + v[18]); // Term for class1

	v[26] = v[20] + v[21] + v[22] + v[23] + v[24] + v[25]; // Sum of terms
	v[0] = 1 - v[26];                                    // Final Gini
RESULT(v[0])

EQUATION("Country_Gini_Index_Pretax")
// Gross income shares, ordered poorest (class6) to richest (class1)
	v[1]=VS(class6, "Class_Gross_Income_Share");
	v[2]=VS(class5, "Class_Gross_Income_Share");
	v[3]=VS(class4, "Class_Gross_Income_Share");
	v[4]=VS(class3, "Class_Gross_Income_Share");
	v[5]=VS(class2, "Class_Gross_Income_Share");
	v[6]=VS(class1, "Class_Gross_Income_Share");
...
// Cumulative gross income shares (S_i), S_0 = 0
	v[13]=v[1];                                  // S_1
	v[14]=v[13] + v[2];                          // S_2
	v[15]=v[14] + v[3];                          // S_3
	v[16]=v[15] + v[4];                          // S_4
...
// Gini terms: P_i * (S_{i-1} + S_i)
	...
	v[26] = v[20] + v[21] + v[22] + v[23] + v[24] + v[25];
	v[0] = 1 - v[26];
RESULT(v[0])

EQUATION("Country_Gini_Index_Wealth")
// Wealth shares, ordered poorest (class6) to richest (class1)
	v[1]=VS(class6, "Class_Wealth_Share");
	v[2]=VS(class5, "Class_Wealth_Share");
	v[3]=VS(class4, "Class_Wealth_Share");
	v[4]=VS(class3, "Class_Wealth_Share");
	v[5]=VS(class2, "Class_Wealth_Share");
	v[6]=VS(class1, "Class_Wealth_Share");
...
// Cumulative wealth shares (S_i), S_0 = 0
	v[13]=v[1];                                  // S_1
	v[14]=v[13] + v[2];                          // S_2
	v[15]=v[14] + v[3];                          // S_3
	v[16]=v[15] + v[4];                          // S_4
