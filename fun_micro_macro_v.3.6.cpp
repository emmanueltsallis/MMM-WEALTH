...
object *input;
object *centralbank;
object *class1; // Top 0.01%
object *class2; // Next 0.09% (class 1 + 2 = top 0.1%)
object *class3; // Next 0.9% (class 1 + 2 + 3 = top 1%)
object *class4; // Next 9% (class 1 + 2 + 3 + 4 = top 10%)
object *class5; // Middle 40% (class 1 + 2 + 3 + 4 + 5 = top 50%)
object *class6; // Bottom 50% (class 1 + 2 + 3 + 4 + 5 + 6 = 100%)
